...
from imputers.mega_layer import MegaEncoderLayer
import os
...
class Residual_block(tf.keras.Model):
    ...
    def __init__(self, res_channels, skip_channels, 
        ...
        self.mega1 = MegaEncoderLayer(2*self.res_channels)
        ...
        self.mega2 = MegaEncoderLayer(2*self.res_channels)
    ...
    def call(self, input_data,training):
        ...
        h = self.conv_layer(h)
        h = self.mega1(tf.transpose(h,(2,0,1)),training=training)
        ...
        h = self.mega2(tf.transpose(h,(2,0,1)),training=training)
        h = tf.transpose(h,(1,2,0))
...
class SSSDmegaImputer(tf.keras.Model):
    ...
    def __init__(self, in_channels, res_channels, skip_channels, out_channels, 
        ...
        Args:
            hyperparameter defined by 'wavenet config'
        """
        super(SSSDmegaImputer, self).__init__()
